...
def _get_valid_access_key_sync() -> Optional[dict]:
    """Return the key with the most time left that still has ≥7 days of TTL.

    Requiring a 7-day minimum ensures a guest who stays a full week will not
    be handed a key that expires mid-stay.  If no key meets the threshold a
    new 30-day key will be auto-generated by the caller.
    """
